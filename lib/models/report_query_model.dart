class ReportQuery {
  ...
  ReportQueryDocument document;

  factory ReportQuery.fromJson(Map<String, dynamic> parsedJson) {
    return ReportQuery(
        document: ReportQueryDocument.fromJson(parsedJson['document']));
  }
}

class ReportQueryDocument {
  ReportQueryDocument({
    required this.name,
  ...
  String name;
  ReportQueryFields fields;
  String createTime;
  String updateTime;

  factory ReportQueryDocument.fromJson(Map<String, dynamic> parsedJson) {
    return ReportQueryDocument(
      name: parsedJson['name'],
      fields: ReportQueryFields.fromJson(parsedJson['fields']),
...
class ReportQueryFields {
  ReportQueryFields({
    required this.reportCreatedAt,
    required this.reportModifiedAt,
    required this.reportCreatedBy,
    required this.reportModifiedBy,
  ...
  TimeStamps reportModifiedAt;
  Strings reportCreatedBy;
  Strings reportModifiedBy;
  Booleans reportStatus;
  ...
  factory ReportQueryFields.fromJson(Map<String, dynamic> parsedJson) {
    return ReportQueryFields(
      reportStatus: Booleans.fromJson(parsedJson["reportStatus"]),
      reportCreatedAt: TimeStamps.fromJson(parsedJson["reportCreatedAt"]),
      reportModifiedAt: TimeStamps.fromJson(parsedJson["reportModifiedAt"]),
      reportCreatedBy: Strings.fromJson(parsedJson["reportCreatedBy"]),
      reportModifiedBy: Strings.fromJson(parsedJson["reportModifiedBy"]),
